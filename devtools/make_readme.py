...
title = "<h1>VSE_Transform_Tools</h1>"

installation = markdown("""
## Installation ##

1. Download the repository. Go to [Releases](https://github.com/doakey3/VSE_Transform_Tools/releases) for a stable version, or click the green button above to get the most recent & unstable version.
2. Open Blender
...
with open('/home/doakey/Sync/Programming/Readme_Experiments/README.rst', 'w') as f:
    f.write(readme)
