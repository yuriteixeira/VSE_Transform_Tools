.. raw:: html
    ...
    transforming.">Delete</a></td>
            <td width=222px><a name="top_Mouse_Track" href="#Mouse_Track" title="Select a transform strip, Press
    Alt+A to play, hold M to
    ...
    <p>Select a transform strip, Press Alt+A to play, hold M to continuously add keyframes to transform strip while tracking the position of the mouse.</p>
